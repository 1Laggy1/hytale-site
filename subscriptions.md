...
<style>
  ...
  /* ЕЛІТНА АНІМАЦІЯ ДЛЯ RUBY */
  .sub-card-ruby:hover {
    transform: translateY(-20px) scale(1.05); 
    border-color: #a50727 !important; 
  }
  ...
  @keyframes rubyPulseGlow {
    0% { box-shadow: 0 0 15px rgba(165, 7, 39, 0.7), 0 0 25px rgba(220, 53, 69, 0.4); }
    100% { box-shadow: 0 0 25px rgba(165, 7, 39, 0.9), 0 0 50px rgba(220, 53, 69, 0.6); }
  }
