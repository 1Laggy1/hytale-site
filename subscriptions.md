...
<div style="max-width: 1200px; margin: 0 auto; padding: 40px 20px; font-family: sans-serif;">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 30px;">
    <div class="sub-card" style="background: var(--vp-c-bg-soft); border: 1px solid var(--vp-c-divider); border-radius: 24px; padding: 40px; text-align: center; transition: transform 0.3s ease, border-color 0.3s ease;">
      ...
      <div style="font-size: 32px; font-weight: bold; color: var(--vp-c-brand); margin-bottom: 25px;">50 грн <span style="font-size: 16px; font-weight: normal; color: var(--vp-c-text-2);">/ міс</span></div>
	...
	<li>✅ Унікальна роль на сервері Discord Quartz</li>
      </ul>
      <a href="https://secure.wayforpay.com/sub/quartz" target="_blank" class="sub-button" style="display: block; background: #6c757d; color: white; padding: 15px; border-radius: 12px; text-decoration: none; font-weight: bold;">Підписатись</a>
    </div>
	...
	<li>✅ Унікальна роль на сервері Discord Amethyst</li>
      </ul>
      <a href="https://secure.wayforpay.com/sub/se2b1b37b0968" target="_blank" class="sub-button" style="display: block; background: var(--vp-c-brand); color: white; padding: 15px; border-radius: 12px; text-decoration: none; font-weight: bold;">Підписатись</a>
    </div>
    <div class="sub-card" style="background: var(--vp-c-bg-soft); border: 1px solid var(--vp-c-divider); border-radius: 24px; padding: 40px; text-align: center; transition: transform 0.3s ease, border-color 0.3s ease;">
      ...
      <div style="font-size: 32px; font-weight: bold; color: var(--vp-c-brand); margin-bottom: 25px;">390 грн <span style="font-size: 16px; font-weight: normal; color: var(--vp-c-text-2);">/ міс</span></div>
      <ul style="text-align: left; list-style: none; padding: 0; margin-bottom: 40px; color: var(--vp-c-text-2); font-size: 15px; line-height: 2;">
        <li>✅ Все, що є в <b>Amethyst</b></li>
        <li>✅ Зміна суфіксу</li>
        <li>✅ Веселковий нікнейм і ефекти</li>
        <li>✅ +15 точок <b>/home</b></li>
        <li>✅ Унікальна роль на сервері Discord Ruby</li>
	<li>✅ Зміна кольору на сервері Discord</li>
	<li>✅ Доступ до чату RUBY на сервері Discord. Пряме спілкування з адміністрацію, тестування, впровадження оновлень</li>
      </ul>
      <a href="https://secure.wayforpay.com/sub/ruby" target="_blank" class="sub-button" style="display: block; background: #dc3545; color: white; padding: 15px; border-radius: 12px; text-decoration: none; font-weight: bold;">Підписатись</a>
    </div>
  </div>
</div>
